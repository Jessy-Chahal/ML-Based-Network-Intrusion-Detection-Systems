...
# 1. train_baseline.py
run_step 1 "$PYTHON_BIN" -m src.model.train_baseline --all

# 2. evaluate_attack_a.py
run_step 2 "$PYTHON_BIN" -m src.attacks.evaluate_attack_a

# 3. evaluate_attack_b.py
run_step 3 "$PYTHON_BIN" -m src.attacks.evaluate_attack_b

# 4. evaluate_attack_c.py
run_step 4 "$PYTHON_BIN" -m src.attacks.evaluate_attack_c

# 5. gen_adversarial_dataset.py
run_step 5 "$PYTHON_BIN" -m src.model.gen_adversarial_dataset

# 6. gen_adversarial_partial.py --attack a
run_step 6 "$PYTHON_BIN" -m src.model.gen_adversarial_partial --attack a

# 7. gen_adversarial_partial.py --attack b
run_step 7 "$PYTHON_BIN" -m src.model.gen_adversarial_partial --attack b

# 8. gen_adversarial_partial.py --attack c
run_step 8 "$PYTHON_BIN" -m src.model.gen_adversarial_partial --attack c

# 9. train_adversarial.py --all
run_step 9 "$PYTHON_BIN" -m src.model.train_adversarial --all

# 10. train_adversarial.py --all --attack a
run_step 10 "$PYTHON_BIN" -m src.model.train_adversarial --all --attack a

# 11. train_adversarial.py --all --attack b
run_step 11 "$PYTHON_BIN" -m src.model.train_adversarial --all --attack b

# 12. train_adversarial.py --all --attack c
run_step 12 "$PYTHON_BIN" -m src.model.train_adversarial --all --attack c

# 13. evaluate_adv_training_clean.py
run_step 13 "$PYTHON_BIN" -m src.evaluate_adv_training_clean

# 14. evaluate_defense.py
run_step 14 "$PYTHON_BIN" -m src.defense.evaluate_defense

# 15. evaluate_defense.py --attack a
run_step 15 "$PYTHON_BIN" -m src.defense.evaluate_defense --attack a

# 16. evaluate_defense.py --attack b
run_step 16 "$PYTHON_BIN" -m src.defense.evaluate_defense --attack b

# 17. evaluate_defense.py --attack c
run_step 17 "$PYTHON_BIN" -m src.defense.evaluate_defense --attack c
